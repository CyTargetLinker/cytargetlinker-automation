...
import.cmd = paste('network import file file="',degs,'" indexColumnSourceInteraction=1 firstRowAsColumnNames=true', sep="")
commandRun(import.cmd)
```
...
commandRun(filter1.cmd)
commandRun(filter2.cmd)
commandRun(filter3.cmd)
